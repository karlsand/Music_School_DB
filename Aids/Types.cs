...
namespace Music_School_DB.Aids
{
    public static class Types
    {
        ...
        public static bool HasAttribute<TAttribute>(this Type? t) where TAttribute : Attribute => Safe.Run(()
            => t?.GetCustomAttributes<TAttribute>()?.FirstOrDefault() is not null, false);
